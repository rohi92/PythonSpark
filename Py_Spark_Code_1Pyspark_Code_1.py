...
final_query=spark.sql("SELECT a.route_id,a.service_id,b.trip_id from trips a LEFT OUTER JOIN stop_times b ON a.trip_id=b.trip_id")
final_query.write.format("orc").save("oci://Python_Spark_Code@idv3oy4sejuc/final_query.orc")
